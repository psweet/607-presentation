...
Eventhough heatmaps can be used with continuous variables, they can be difficult to digest. Ideally, heatmaps are used to visualize two categorical variables and a single continuous variable.
